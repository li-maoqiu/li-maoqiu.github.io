...
function 复(o){o=o||制;o=o.replace(new RegExp('［引号］',"g"),'"');document.getElementById('复制').value=o;let 复制=document.querySelector('#复制');复制.select();document.execCommand("Copy");notyf.confirm("已复制：<br>"+o)}
